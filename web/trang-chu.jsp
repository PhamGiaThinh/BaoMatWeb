...
<div class="main-menus">
    <div class="title">
        <img src="assests/images/logo.png" height="50" width="50" alt=""/>
                ...
                <div class="food-item col-md-3 col-sm-6 col-12 mb-5">
                    <a href="chi-tiet-mon-an?idMonAn=${monAn.idMonAn}">
                        ...
                        <p class="price old-price"
                                style="position: absolute; right: 17px;top: 208px;">${monAn.khuyenMai == 0 ? '': monAn.gia + (monAn.gia * monAn.khuyenMai)/100 }
                        </p>
                    </a>
                </div>
            </c:forEach>
        ...
        <div class="emp-list">
            <div class="row">
                <div class="col-md-3 col-sm-6 col-12 emp">
                    <img src="assests/images/nguoidung/dien.jpg" alt=""/>
                    <p style="font-size: 30px;">Nguyễn Lê Điền
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 col-12 emp">
                    <img src="assests/images/nguoidung/trang.jpg" alt=""/>
                    <p style="font-size: 30px;">Nguyễn Trường Tráng
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 col-12 emp">
                    <img src="assests/images/nguoidung/thinh.jpg" alt=""/>
                    <p style="font-size: 30px;">Phạm Gia Thịnh
                    </p>
                </div>
                <div class="col-md-3 col-sm-6 col-12 emp">
                    <img src="assests/images/nguoidung/dieu.jpg" alt=""/>
    ...
    <div class="container">
        ...
        <div class="comment-list">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="avatar-people-cmt" src="assests/images/nguoidung/khach-duyen.jpg" alt=""/>
                        <p class="cmt-text">
                            <i>
                    ...
                    <div class="carousel-item">
                        <img class="avatar-people-cmt" src="assests/images/nguoidung/khach-duong.jpg" alt=""/>
                        <p class="cmt-text">
                    ...
                    <div class="carousel-item">
                        <img class="avatar-people-cmt" src="assests/images/nguoidung/khach-xuan-nguyen.jpg" alt=""/>
                        <p class="cmt-text">
                            <i>
                    ...
                    <div class="carousel-item">
                        <img class="avatar-people-cmt" src="assests/images/nguoidung/tan.jpg" alt=""/>
                        <p class="cmt-text">
                            <i>
...
<div class="blogs container">
    <div class="blog-title">
        ...
        <img src="assests/images/logo.png" width="100" height="100" alt=""/>
        <p>

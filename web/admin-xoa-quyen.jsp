...
<div class="card">
    <div class="card-body">
        <h2 class="card-title">Xóa quyền: ${requestScope.rquyen.tenQuyen}</h2>
        <p class="card-description">Thông tin chi tiết</p>
        <div class="row" style="margin-bottom: 16px;">
            <table class="table">
            <tr>
                <td>Tên quyền</td>
                <td>${requestScope.quyen.tenQuyen}</td>
            </tr>
            <tr>
                <td>Mô tả</td>
                <td>${requestScope.quyen.moTa}</td>
            </tr>
            <tr>
                <td>ID nghiệp vụ</td>
                <td>${requestScope.quyen.idNghiepVu}</td>
            </tr>
            </table>
        <form action="admin/xoa-quyen" method="post">
            <input type="hidden" value="${requestScope.quyen.idQuyen}" name="txtIdQuyen">

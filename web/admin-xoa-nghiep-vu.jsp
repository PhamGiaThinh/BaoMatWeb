...
<div class="card">
    <div class="card-body">
        <h2 class="card-title">Xóa nghiệp vụ: ${requestScope.nghiepVu.tenNghiepVu}</h2>
        <p class="card-description">Thông tin chi tiết</p>
        <div class="row" style="margin-bottom: 16px;">
            <table class="table">
                <tr>
                    <td>Tên quyền</td>
                    <td>${requestScope.nghiepVu.tenNghiepVu}</td>
                </tr>
            </table>
            <form action="admin-xoa-nghiep-vu" method="post">
                <input type="hidden" value="${requestScope.nghiepVu.idNghiepVu}" name="txtIdNghiepVu">
